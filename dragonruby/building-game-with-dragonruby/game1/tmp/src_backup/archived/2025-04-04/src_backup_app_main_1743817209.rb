...
def explosion(x, y)
  ...
  #explosion_sprite_index = 0.frame_index(count: 7, hold_for: 3, repeat: false)
  #args.state.explosion.path = "sprites/misc/explosion-#{explosion_sprite_index}.png"
end
  ...
  args.state.fireballs.each do |fireball|
    ...
    args.state.targets.each do |target|
      if args.geometry.intersect_rect?(target, fireball)
        ...
        #hopefully makes explosions at the position of the hit target
        explosion = args.geometry.rect_center_point(target)
