...
def render_max_width_max_height_examples args
  ...
  args.outputs.labels << Layout.rect(row: 4, col: 12).merge(text: "max width/height examples", anchor_x: 0.5,
                                                            anchor_y: 0.5)
...
def render_points_with_anchored_label_examples args
  ...
  args.outputs.labels << Layout.rect(row: 6, col: 3, w: 6, h: 1).center.merge(
    text: "layout.point anchored to 0.0, 0.0", anchor_x: 0.5, anchor_y: 0.5, size_px: 15
  )
  grey = { r: 128, g: 128, b: 128 }
  args.outputs.solids << Layout.rect(row: 7, col: 4.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 4.5, row_anchor: 1.0, col_anchor: 0.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 7, col: 5.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 5.5, row_anchor: 1.0, col_anchor: 0.5).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 7, col: 6.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 6.5, row_anchor: 1.0, col_anchor: 1.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 4.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 4.5, row_anchor: 0.5, col_anchor: 0.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 5.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 5.5, row_anchor: 0.5, col_anchor: 0.5).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 6.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 6.5, row_anchor: 0.5, col_anchor: 1.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 4.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 4.5, row_anchor: 0.0, col_anchor: 0.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 5.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 5.5, row_anchor: 0.0, col_anchor: 0.5).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 6.5).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 6.5, row_anchor: 0.0, col_anchor: 1.0).merge(text: "[x]",
                                                                                                anchor_x: 0.5, anchor_y: 0.5, **label_color)
end
...
def render_centered_rect_examples args
  ...
  args.outputs.labels << Layout.rect(row: 6, col: 9, w: 6, h: 1).center.merge(
    text: "layout.rect centered inside another rect", anchor_x: 0.5, anchor_y: 0.5, size_px: 15
  )
...
def render_rect_group_examples args
  args.outputs.labels << Layout.rect(row: 6, col: 15, w: 6, h: 1).center.merge(text: "layout.rect_group usage",
                                                                               anchor_x: 0.5, anchor_y: 0.5, size_px: 15)
