...
def tick_origin_center args
  ...
  args.outputs.labels << { x: 0, y: 100,
                           text: "args.grid.origin_center! with sprite inside of a render target, centered at 0, 0", vertical_alignment_enum: 1, alignment_enum: 1 }
...
def tick_origin_bottom_left args
  ...
  args.outputs.labels << { x: 640, y: 360 + 100,
                           text: "args.grid.origin_bottom_left! with sprite inside of a render target, centered at 640, 360", vertical_alignment_enum: 1, alignment_enum: 1 }
