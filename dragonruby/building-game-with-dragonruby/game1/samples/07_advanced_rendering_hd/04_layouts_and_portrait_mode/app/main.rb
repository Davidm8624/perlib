def tick args
  args.outputs.solids << Layout.rect(row: 0, col: 0, w: 12, h: 24, include_row_gutter: true, include_col_gutter: true).merge(
    b: 255, a: 80
  )

  # rows (light blue)
  light_blue = { r: 128, g: 255, b: 255 }
  args.outputs.labels << Layout.rect(row: 1, col: 3).merge(text: "row examples", vertical_alignment_enum: 1,
                                                           alignment_enum: 1)
  ...
  args.outputs.labels << Layout.rect(row: 1, col: 9).merge(text: "column examples", vertical_alignment_enum: 1,
                                                           alignment_enum: 1)
  6.times do |col|
  ...
  args.outputs.labels << Layout.rect(row: 4, col: 6).merge(text: "max width/height examples",
  ...
  args.outputs.labels << Layout.rect(row: 5.5, col: 6).merge(text: "labels using Layout.point anchored to 0.0, 0.0",
                                                             vertical_alignment_enum: 1, alignment_enum: 1)
  grey = { r: 128, g: 128, b: 128 }
  args.outputs.solids << Layout.rect(row: 7, col: 4).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 4, row_anchor: 1.0, col_anchor: 0.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 7, col: 5).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 5, row_anchor: 1.0, col_anchor: 0.5).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 7, col: 6).merge(**grey)
  args.outputs.labels << Layout.point(row: 7, col: 6, row_anchor: 1.0, col_anchor: 1.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 4).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 4, row_anchor: 0.5, col_anchor: 0.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 5).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 5, row_anchor: 0.5, col_anchor: 0.5).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 8, col: 6).merge(**grey)
  args.outputs.labels << Layout.point(row: 8, col: 6, row_anchor: 0.5, col_anchor: 1.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 4).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 4, row_anchor: 0.0, col_anchor: 0.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 5).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 5, row_anchor: 0.0, col_anchor: 0.5).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  args.outputs.solids << Layout.rect(row: 9, col: 6).merge(**grey)
  args.outputs.labels << Layout.point(row: 9, col: 6, row_anchor: 0.0, col_anchor: 1.0).merge(text: "[x]",
                                                                                              alignment_enum: 1, vertical_alignment_enum: 1, **label_color)

  # centering rects
  args.outputs.labels << Layout.rect(row: 10.5, col: 6).merge(text: "layout.rect centered inside another layout.rect",
                                                              vertical_alignment_enum: 1, alignment_enum: 1)
  ...
  args.outputs.labels << Layout.rect(row: 16.5, col: 6).merge(text: "layout.rect_group usage",
                                                              vertical_alignment_enum: 1, alignment_enum: 1)
